 ...
 * The type Easy.
 */
public class Easy implements LevelInformation {
    ...
    public Sprite getBackground() {
        Sprite backRound = new Block(new Point(0, 0), 800, 600, Color.darkGray.darker());
        return backRound;
    }
    ...
    public ArrayList<Block> blocks() {
        ...
        double x = RIGHTEDGE - WIDTH;
        double y = STARTY;
        int height = HIGHT;
        int width = WIDTH;
        double limit = LEFTEDGE;
